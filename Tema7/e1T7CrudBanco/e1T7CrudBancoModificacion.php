...
// Conexión a la base de datos
      ...
      ?>
        ...
        Por favor, vuelva a la <a href="e1T7CrudBanco.php">inicio</a>.
      <?php
      } else {
        $insercion = "UPDATE `cliente` SET `dni`='". $_POST[dniModificado] .
                "', `nombre`='". $_POST[nombreModificado] .
                "', `direccion`='". $_POST[direccionModificado] .
                "', `telefono`='". $_POST[telefonoModificado] .
                "' WHERE `dni`=". $_POST[dniModificacion];
        //echo $insercion;
