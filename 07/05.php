...
error_reporting(0);
    ...
    $$datosTienda = "SELECT codigo, descripcion, precio_compra, precio_venta, stock FROM articulo";
    ...
    // Listado /////////////////////////////////////////////////
    $$datosTienda = "SELECT codigo, descripcion, precio_compra, precio_venta, stock FROM articulo ORDER BY descripcion LIMIT ".(($_SESSION['pagina'] - 1) * 5).", 5";
    $consulta = mysql_query($$datosTienda, $conexion);
    // Listado /////////////////////////////////////////////////
    ?>
    ...
    <table  class="table table-striped">
      <tr>
        ...
        <th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Margen&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
        <th>Stock</th>
        <th><a class="btn btn-danger" href="pagina.php?ejercicio=05_venta" role="button">Venta</a></th>
        <th></th>
        <th></th>
        <th></th>
      </tr>
      ...
      <tr>
        ...
        <td>
          <form action="pagina.php" method="post">
            <input type="hidden" name="ejercicio" value="05_borrar_articulo_confirmacion">
        ...
        <td>
          <form action="pagina.php" method="post">
            <input type="hidden" name="ejercicio" value="05_modificar_articulo">
            <input type="hidden" name="codigo" value="<?=$registro[codigo]?>">
            <input type="hidden" name="descripcion" value="<?=$registro[descripcion]?>">
            <input type="hidden" name="precio_compra" value="<?=$registro[precio_compra]?>">
            <input type="hidden" name="precio_venta" value="<?=$registro[precio_venta]?>">
        ...
        <td>
          <form action="pagina.php" method="post">
            <input type="hidden" name="ejercicio" value="05_entrada_articulo">
            <input type="hidden" name="codigo" value="<?=$registro[codigo]?>">
            <input type="hidden" name="descripcion" value="<?=$registro[descripcion]?>">
            <input type="hidden" name="precio_compra" value="<?=$registro[precio_compra]?>">
            <input type="hidden" name="precio_venta" value="<?=$registro[precio_venta]?>">
